...
venue: "By the Netherlands Institute for the Study of Crime and Law Enforcement (NSCR)"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Vrije Universiteit Amsterdam, De Boelelaan 1109B, 1081 HV Amsterdam. Room information will be communicated after registration"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "52.333601"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "4.867339"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Nov 17, 18, 24, and 25, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "10:00 - 15:00 UTC + 1"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Asier Moneva"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Wim Bernasco", "Danielle Stibbe"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
# eventbrite: "977884808787"          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
